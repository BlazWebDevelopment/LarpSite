      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex items-center gap-2 text-sm text-gray-500">
            ...
            <span className="text-gray-700 font-medium">{language === 'en' ? 'Search Results' : '搜索结果'}</span>
          </div>
        </div>
      </div>
        ...
        <div className="flex gap-8">
          <div className="flex-1">
            <div className="bg-white border border-gray-200 rounded-2xl overflow-hidden">
              <div className="bg-gray-900 text-white px-6 py-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                <h1 className="font-extrabold text-lg flex items-center gap-2">
                  <span className="w-1 h-5 bg-emerald-500 rounded shrink-0" />
          ...
          <aside className="hidden lg:block w-80 shrink-0 space-y-6">
            <div className="bg-white border border-gray-200 rounded-2xl overflow-hidden">
              <div className="bg-gray-900 text-white px-5 py-3.5 font-bold text-sm">
                {language === 'en' ? 'Popular Searches' : '热门搜索'}
              </div>
              <div className="p-4">
                <div className="flex flex-wrap gap-2">
                  <Link
                    href="/search?q=Neuralink"
                    className="bg-emerald-50 text-emerald-600 px-3 py-1 text-sm rounded-lg hover:bg-emerald-100 border border-emerald-200 transition-colors"
                  >
                    Neuralink
                  </Link>
                  <Link
