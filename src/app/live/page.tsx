            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 chinese-border-top">
              <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100">
                <h1 className="font-bold text-lg text-gray-800 flex items-center gap-2">
                  ...
                  {language === 'en' ? 'Live' : '直播'}
                  <span className="w-2 h-2 bg-blue-600 rounded-full animate-pulse ml-2"></span>
                </h1>
              </div>
              <div className="p-4">
                      ...
                      <div className={`flex gap-4 pb-4 ${index < liveArticles.length - 1 ? 'border-b border-gray-100' : ''}`}>
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-1">
                            <span className="bg-blue-700 text-white text-xs px-1.5 py-0.5 font-medium rounded">{language === 'en' ? 'LIVE' : '直播'}</span>
