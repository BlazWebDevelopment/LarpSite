...
export const articles: Article[] = [
  ...
  /*{
    ...
    body: [
      ...
      {
        type: 'image',
        src: '/images/Mikolas.png',
        caption: 'Mikolas, the pygmy hippo Neuralink has reportedly selected for its largest animal-testing program so far. (Image: facility photo shared with DCN News.)',
